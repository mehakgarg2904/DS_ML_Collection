...
<br></br>
##
  ### 4. Now click on the "*Notebooks*" folder and click on "*Upload Files. Or can clone and edit if Familiar with Git or Github Desktop*. Add Dataset too, or use a "**URL" to Read Datasets in NBs"📁.
...
##
#### Now you just have to repeat the steps 4 to 7 for 3 more times with different Notebooks in order to be eligible for a free T-shirt👕 and stickers🤩.
...
#### If you need any help, Contact me at **9306219924**(WhatsApp) at any time 24*7.😊
##
